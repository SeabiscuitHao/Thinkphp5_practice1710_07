<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:74:"F:\www\practice_tp\think\public/../application/index\view\index\index.html";i:1507358540;s:76:"F:\www\practice_tp\think\public/../application/index\view\common\header.html";i:1506598287;s:75:"F:\www\practice_tp\think\public/../application/index\view\common\right.html";i:1507356503;s:74:"F:\www\practice_tp\think\public/../application/index\view\common\foot.html";i:1505394084;}*/ ?>
...
<div class="overall">
	...
	<div class="left">
				<?php if(is_array($articleres) || $articleres instanceof \think\Collection || $articleres instanceof \think\Paginator): $i = 0; $__LIST__ = $articleres;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
					<div class="xnews2">
					<div class="pic"><a target="_blank" href="<?php echo url('article/index',array('arid' => $vo['id'])); ?>"><img src="<?php if($vo['pic'] != ''): ?>
